"""
This module contains the SequenceDataset class
that transforms the raw data into a collection
of sequences
"""
import numpy as np
import torch
...
class SequenceDataset(torch.utils.data.Dataset):
    ...
    def preprocess(self, text:str)->torch.Tensor:
        ...
        encodes it into IDs and pads it, and one-hot encodes the sequence and returns it in the
        permuted form.
        ...
        # One-hot encode
        one_hot_seq = torch.nn.functional.one_hot(seq.to(torch.int64),
